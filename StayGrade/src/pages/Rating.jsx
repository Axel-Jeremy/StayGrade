...
import { reviewStore, setReviewStore } from "../stores/ReviewStore";
      ...
      <div id="body" class={showModal() ? "blurred" : ""}>
        ...
        <div>
          ...
          <div class={style.containerBottomContent}>
            <Show
              when={reviewStore.reviews.length > 0}
              fallback={<p>Belum ada review untuk hotel ini.</p>}
            >
              <For each={reviewStore.reviews}>
                {(rating) => (
                  <ReviewCard
                    id={rating.id}
